  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setAllAssessmentData(response.data.assessments.reverse());
      } catch (error) {
        ...
        <div className="flex justify-between">
          <div>
            {isLoading ? (
              ...
              <h1 className="text-2xl font-[#jost] mb-6 font-bold">
                Assessments
              </h1>
            )}
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-500 mb-3">
                      ...
                      <div className="flex items-center gap-1">
                        <Calendar className="h-4 w-4 text-[#219CAE]" />
                        <span>
                    ...
                    <p className="text-sm text-gray-500 mb-3">
                      {assessment.invitedStudents.length || 0} candidates
                      invited.
                    </p>
                    ...
                    <div className="flex flex-wrap justify-end gap-3">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        className="text-[#F68622] border-[#F68622] bg-transparent"
                        onClick={(e) => {
                          e.stopPropagation();
                          router.push(`/college/students?id=${assessment._id}`);
                        }}
                      >
