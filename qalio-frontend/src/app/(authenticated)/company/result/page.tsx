...
export default function CompanyResult() {
  ...
  // Transform assessment data for chart (last 5 jobs only)
  const chartData = assessmentData
    // Get last 5 jobs only
    .map((item: any) => ({
      name: item.jobTitle,
      value: item.assessment?.appearedStudents?.length || 0,
      fullName: item.jobTitle,
          ...
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-600 mb-4">
              {isFirstTimeUser
                ...
                : "You haven't created any jobs with assessments yet. Start creating assessments and then attach it with jobs to see your results here."}
            </p>
            <div className="space-y-3">
              <button
                onClick={() => router.push("/company/assessments")}
              ...
              >
                ...
                {isFirstTimeUser
                  ? "Create Your First Job with Assessment"
                  : "Create Jobs"}
              </button>
