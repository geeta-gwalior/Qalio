...
import StudentTopicReportPDF from "@/components/common/StudentTopicReportPDF"; // you’ll create this next
    ...
    const fetchStudentAssessmentResult = async () => {
      try {
        ...
        const res = await axios.get(
          `${process.env.NEXT_PUBLIC_QALIO_BACKEND_URL}/student/student/result/${assessmentId}`,
          {
            params: {
              studentId,
            },
        ...
        // Select the most recent completed attempt by default
    ...
    <div className="min-h-screen bg-gray-50 py-4">
      <div className="w-full mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          <BackHeader
            title={`${assessment?.name}/ ${studentInfo?.name || "Student"}`}
          />
                            ...
                            {selectedAnswers.map(
                              (answer: string, answerIndex: number) => (
                                <Badge
                                  key={answerIndex}
                                  variant="outline"
                                  className="bg-blue-50 text-blue-700 border-blue-200 max-w-full break-words whitespace-normal"
                                >
